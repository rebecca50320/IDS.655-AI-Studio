...
**Next:** Replace with a finance API (Alpha Vantage or Finnhub) or resolve SerpAPI auth.
...
**Next:** Add Gmail API with OAuth token caching or SMTP with an app password as an optional send step.
